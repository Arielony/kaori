...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel->setText(QStringLiteral("<html><head/><body><p>Copyright &amp;copy; 2009-YYYY The Bitcoin developers</p><p>Copyright &amp;copy; 2017-YYYY Kaori developers</p><p>MacOS build by <a href=\"https://ninjas.cl\"><span style=\" text-decoration: underline; color:#0000ff;\">Ninjas.cl</span></a></p></body></html>"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Kaori", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Kaori</b> version", Q_NULLPTR));
