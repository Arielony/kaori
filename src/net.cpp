...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Kaori " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"pool.kaori.cl", "pool.kaori.cl"},
    {"explorer.kaori.cl", "explorer.kaori.cl"},
    {"dns1.kaori.cl", "dns1.kaori.cl"},
    {"dns2.kaori.cl", "dns2.kaori.cl"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Kaori is probably already running."), addrBind.ToString().c_str());
        else
